...
class model_config:
    ...
    def __init__(self, args, dataset_config):
        ...
        # preencoder: Point Transformer v3 specific
        self.in_channel = (
        ...
        self.enc_type = 'point_transformer_v3'
        self.enc_nlayers = 6  # Point Transformer v3 typically uses more layers
        self.enc_dim = 256
        self.enc_ffn_dim = 512  # Larger FFN for Point Transformer v3
        self.enc_dropout = 0.1
        self.enc_nhead = 8  # More heads for Point Transformer v3
        self.enc_activation = 'relu'
        
        # decoder (same as Vote2Cap-DETR)
        self.nqueries = 256
        self.dec_nlayers = 8
        self.dec_dim = 256
